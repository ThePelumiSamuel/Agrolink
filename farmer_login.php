...
<div class="container-fluid">
    <div class="row">
    <form class="col-md-4 offset-md-4 mt-5 mb-5 p-4 p-md-5 bg-white rounded shadow border rounded-3 bg-light" action="process/process_farmerlogin.php" method="post">
        ...
        <img src="assets/images/fields.png" alt="Logo" width="50" height="34" class="d-inline-block align-text-top mb-2">
            <h1 class="text-success">Farmer Login</h1>
    ...
    <?php
       ...
       ?>
        ...
        <button class="w-100 btn btn-success custom-btn noround btn-md" type="submit" name="btnflogin">Login!</button>
        <hr class="my-4">
